...
export const blogPosts: BlogPost[] = [
  {
    ...
    content: `
      <h3>Introduction: The New Digital Imperative</h3>
      ...
      <h3>Old Structures vs. New Realities: key challenges for legacy brands</h3> 
      ...
      <h3>New value creation opportunities in Direct-to-Consumer models</h3>
      ...
      <h3>Strategic shifts to embrace digital-first experiences</h3>
      ...
      <h3>Conclusion: thriving in a Direct-to-Consumer era</h3>
