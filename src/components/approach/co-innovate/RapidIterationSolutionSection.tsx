  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 bg-brand-50 p-8 rounded-lg border border-brand-100">
          <H3 className="text-center mb-8">Benefits of Rapid Iteration</H3>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="flex flex-col items-center text-center p-4">
              <div className="text-4xl font-bold text-brand-600 mb-2">94%</div>
              <Paragraph className="text-brand-700 font-medium">Teams stay engaged and energized</Paragraph>
            </div>
            
            <div className="flex flex-col items-center text-center p-4">
              <div className="text-4xl font-bold text-brand-600 mb-2">5x</div>
              <Paragraph className="text-brand-700 font-medium">Learning cycles accelerate</Paragraph>
            </div>
            
            <div className="flex flex-col items-center text-center p-4">
              <div className="text-4xl font-bold text-brand-600 mb-2">70%</div>
              <Paragraph className="text-brand-700 font-medium">Market feedback arrives faster</Paragraph>
            </div>
            
            <div className="flex flex-col items-center text-center p-4">
              <div className="text-4xl font-bold text-brand-600 mb-2">3x</div>
              <Paragraph className="text-brand-700 font-medium">Decision fatigue diminishes</Paragraph>
            </div>
          </div>
        </div>
      </div>
