      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-block bg-brand-100 text-brand-600 px-4 py-1 rounded-full mb-4">
              <span className="text-sm font-medium">Ready to accelerate your innovation?</span>
            </div>
            <H2 className="mb-6 text-brand-600">Take the First Step Towards Rapid Innovation</H2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            ...
            <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow border-0 relative">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-brand-600 text-white px-4 py-1 rounded-full">
