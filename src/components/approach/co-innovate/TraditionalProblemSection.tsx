...
import { Clock, TrendingDown, AlertCircle, FileX } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-12 p-6 bg-red-50 rounded-lg border border-red-100">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="text-3xl font-bold text-red-600 whitespace-nowrap">The innovation gap</div>
            <div className="w-full h-0.5 bg-red-200"></div>
            <div className="text-xl font-semibold text-red-600">70-95%</div>
          </div>
