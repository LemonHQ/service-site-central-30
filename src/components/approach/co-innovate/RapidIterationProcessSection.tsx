    ...
    <section className="py-16 bg-green-50">
      <div className="container mx-auto px-4">
        ...
        <div className="relative mt-20">
          ...
          <div className="hidden lg:block absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] border-4 border-dashed border-green-200 rounded-full"></div>
            ...
            {processSteps.map((step, index) => (
              <div key={index} className="relative flex flex-col items-center text-center">
                ...
                <div className="bg-white rounded-lg p-6 shadow-md z-10">
                  <div className="inline-block bg-green-500 text-white rounded-full w-8 h-8 flex items-center justify-center text-sm font-bold mb-4">
                    {step.number}
                  </div>
                  <H3 className="text-green-700 mb-3">{step.title}</H3>
                ...
                {index < processSteps.length - 1 && (
                  <div className="hidden lg:block absolute top-20 left-full w-full transform -translate-x-1/2 z-0">
                    <div className="border-t-2 border-green-300 w-full"></div>
                  </div>
                )}
              </div>
            ))}
        ...
        <div className="mt-20 text-center">
          <H3 className="text-green-700 mb-6">Rapid Iteration is Cyclical</H3>
