      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {partners.map((partner, index) => (
            <div key={index} className="p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow bg-ivory-100">
              ...
              <h3 className="text-lg font-normal text-center mb-2 text-gray-800">{partner.name}</h3>
              <p className="text-sm text-gray-600 text-center font-light">{partner.description}</p>
            </div>
          ))}
        </div>
      </div>
