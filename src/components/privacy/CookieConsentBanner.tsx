        ...
        <div className="bg-card border-t border-border shadow-lg p-4 sm:p-6"
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="flex-1">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-1"
                    ...
                    <span className="font-bold text-xs" style={{ color: 'hsl(var(--primary-foreground))' }}>L</span>
                  </div>
                  <div>
                    <h3 className="font-semibold mb-2" style={{ color: 'hsl(var(--card-foreground))' }}>
              ...
              <button
                onClick={hideBanner}
                className="absolute top-2 right-2 p-1 rounded-full transition-colors lg:static lg:p-2 hover:opacity-70"
