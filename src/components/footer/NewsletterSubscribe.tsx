  ...
  return <div>
      ...
      <form onSubmit={handleSubscribe} className="space-y-4">
        ...
        <div className="flex items-start space-x-2">
          <Checkbox id="newsletter-marketing-consent" checked={marketingConsent} onCheckedChange={checked => setMarketingConsent(checked === true)} />
          <label htmlFor="newsletter-marketing-consent" className="text-sm text-gray-600">
