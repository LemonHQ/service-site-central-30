...
const StandardizingIntellectualPropertyPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  
  const caseStudy = caseStudies.find(cs => cs.id === 'standardizing-intellectual-property-management')!;
...
export default StandardizingIntellectualPropertyPage;