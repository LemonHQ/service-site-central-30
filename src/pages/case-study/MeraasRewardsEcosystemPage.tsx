...
const MeraasRewardsEcosystemPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  
  const caseStudy = caseStudies.find(cs => cs.id === 'how-meraas-used-a-live-pilot-to-strategize-the-next-major-rewards-ecosystem')!;
...
export default MeraasRewardsEcosystemPage;