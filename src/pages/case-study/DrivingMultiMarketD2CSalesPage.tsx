...
const DrivingMultiMarketD2CSalesPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  
  const caseStudy = caseStudies.find(cs => cs.id === 'driving-multi-market-d2c-sales')!;
...
export default DrivingMultiMarketD2CSalesPage;