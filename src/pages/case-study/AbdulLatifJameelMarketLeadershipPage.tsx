...
const AbdulLatifJameelMarketLeadershipPage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  
  const caseStudy = caseStudies.find(cs => cs.id === 'how-abdul-latif-jameel-established-its-market-leadership')!;
...
export default AbdulLatifJameelMarketLeadershipPage;