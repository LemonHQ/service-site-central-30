...
const ReimaginingPatientExperiencePage = () => {
  const [lightboxOpen, setLightboxOpen] = useState(false);
  const [currentImageIndex, setCurrentImageIndex] = useState<number | null>(null);
  
  const caseStudy = caseStudies.find(cs => cs.id === 'reimagining-patient-experience')!;
...
export default ReimaginingPatientExperiencePage;